...
const index_1 = require("../../../zcl/index");
...
exports.Endpoints = [
    ...
    { ...EndpointDefaults, endpoint: 10, appprofid: 0x0104 },
    {
        ...
        appdeviceid: 0x0400,
        appnumoutclusters: 2,
        appoutclusterlist: [index_1.Clusters.ssIasZone.ID, index_1.Clusters.ssIasWd.ID],
        appnuminclusters: 2,
        // genTime required for https://github.com/Koenkk/zigbee2mqtt/issues/10816
        appinclusterlist: [index_1.Clusters.ssIasAce.ID, index_1.Clusters.genTime.ID]
    },
    ...
    { ...EndpointDefaults, endpoint: 12, appprofid: 0xc05e },
    {
        ...
        appprofid: 0x0104,
        appnuminclusters: 1,
        appinclusterlist: [index_1.Clusters.genOta.ID]
    },
